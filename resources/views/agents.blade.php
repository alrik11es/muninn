                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-xs" style="float: right">
                                    <a class="btn btn-default" href="/scenarios/{{$agent->id}}">Show</a>
                                    <a class="btn btn-default" href="/scenarios/{{$agent->id}}/edit">Edit</a>
                                    <a class="btn btn-default" href="/scenarios/{{$agent->id}}/share">Share</a>
                                    <a data-toggle="modal" data-target="#confirm-scenario-deletion-{{$agent->id}}" class="btn btn-default" href="#">Delete</a>
